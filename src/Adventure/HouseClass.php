...
class HouseClass
{
    ...
    */
    public function resetHouse(): void
    {
        $arrays = [
            ["visit", "counter", "0"],
            ["first message", "message", "After dreaming of my blacksmith grandfather, the person which legacy I inherited. With honor and responsibility, I embarked on my own adventure, forging a path filled with challenges and surprises. If you need help type 'help'."],
